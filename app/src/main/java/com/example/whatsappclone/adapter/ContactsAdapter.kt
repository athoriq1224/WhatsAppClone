...
import com.example.whatsappclone.activity.ContactsActivity
import com.example.whatsappclone.listener.ContactsClickListener
...
class ContactsAdapter(val contacts : ArrayList<Contact>):
    ...
    class ContactsViewHolder(override val containerView: View):
        ...
        fun bindItem(contact: Contact, listener: ContactsClickListener?){
            ...
            txt_contact_number.text = contact.name
    ...
    fun setOnItemclikListener(listener: ContactsClickListener){
